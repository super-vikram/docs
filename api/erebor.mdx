...
Erebor is the primary management backend for SuperVaults. Go service, ~89 REST endpoints organized into 14 domains.
...
All under `/api/v1/vaults/{chain_id}/{vault_address}/analytics/`:
...
Available for automation. See [Webhooks & Event Streaming](/automation/webhooks).
