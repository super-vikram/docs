...
<Warning>
The **Superman Python** backend (ladder, history, services) does not yet have an OpenAPI spec. The [Superman API reference](/api/superman) is manually maintained. Treat endpoint shapes as best-effort until a spec is generated.
</Warning>
...
The JWT is issued by Dynamic.xyz upon wallet connection. See [Authentication](/authentication) for the full flow.
