...
| Environment | URL |
|-------------|-----|
| Production | [superman.superform.xyz](https://superman.superform.xyz) |
...
| **Superman** (keeper operations) | `https://superman-api.superform.xyz` | ❌ Not yet generated |
...
| Alerts | Manager (mock/placeholder) |

## Getting Access

**Joining an existing vault:** The primary manager adds you via [User Management](/ui/user-management) as a secondary manager (on-chain transaction) or view-only user (off-chain).
